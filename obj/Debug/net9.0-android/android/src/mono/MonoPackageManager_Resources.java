...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CRadventure.dll" comes first in this list. */
		"CRadventure.dll",
		"GoogleGson.dll",
		...
		"Xamarin.AndroidX.Credentials.dll",
		"Xamarin.AndroidX.Credentials.PlayServicesAuth.dll",
		...
		"Xamarin.GoogleAndroid.Libraries.Identity.GoogleId.dll",
